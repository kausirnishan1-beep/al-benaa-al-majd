...
VALUES 
  ('benaa', 'Al-Benaa Construction', 'شركة البناء للمقاولات العامة', 'General Contracting, Construction, Renovation & Project Management', 'إنشاءات، تجديد، صيانة، وإدارة مشاريع', 'Leading Saudi contracting company executing high-end residential, commercial, and industrial construction projects with uncompromised quality standards.', 'شركة مقاولات سعودية رائدة تنفذ المشاريع السكنية والتجارية والصناعية بأعلى معايير الجودة العالمية.', 'benaa', '/logo/al-benaa-logo.svg', '/benaa'),
  ('majd', 'Al-Majd General Trading', 'شركة المجد للتجارة والاستيراد والتصدير', 'Import & Export, Global Product Sourcing & Logistics Solutions', 'استيراد وتصدير، تجارة عامة، وحلول لوجستية', 'Premier international trading arm connecting global markets with high-grade construction materials, industrial equipment, and supply chain excellence.', 'ذراع تجاري دولي يربط الأسواق العالمية بأجود مواد البناء والمعدات الصناعية والحلول اللوجستية المتكاملة.', 'majd', '/logo/al-majd-logo.svg', '/majd')
...
VALUES
  (1, 'Luxury Residential Compound - Riyadh', 'مجمع سكني فاخر - الرياض', 'benaa', 'construction', 'Al-Benaa Construction', 'شركة البناء', 'https://images.unsplash.com/photo-1541888946425-d0fbb18086f6?auto=format&fit=crop&w=800&q=80', 'Turnkey execution of a premier modern residential community spanning 12,000 m² built to Saudi Building Code specifications.', 'تنفيذ مجمع سكني متكامل ومطابق لأعلى مواصفات البناء الحديثة وكود البناء السعودي بمساحة 12,000 م².', 'Riyadh, Saudi Arabia', 'الرياض، المملكة العربية السعودية', '2026', true),
  (2, 'Corporate Headquarters Modernization', 'تجديد وتطوير مقر إداري وتجاري', 'benaa', 'renovation', 'Al-Benaa Construction', 'شركة البناء', 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=800&q=80', 'Comprehensive architectural, structural, and smart energy modernization for prime commercial premises.', 'إعادة تأهيل وتجديد معماري وإنشائي كامل للمقر الرئيسي ودمج أنظمة الطاقة الذكية.', 'Riyadh, Saudi Arabia', 'الرياض، المملكة العربية السعودية', '2025', true),
  (3, 'Building Materials Supply Contract', 'توريد مواد بناء ومعدات هندسية', 'majd', 'import-export', 'Al-Majd Trading', 'شركة المجد', 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=800&q=80', 'Procurement and direct site delivery of high-tensile structural steel and waterproofing membranes from top global mills.', 'توريد حديد التسليح عالي المقاومة والمواد العازلة ومستلزمات الإنشاءات من كبرى المصانع العالمية.', 'Dammam / Jubail Ports', 'موانئ الدمام والجبيل', '2026', true),
  (4, 'Commercial Plaza Fit-Out & MEP', 'تجهيز وتشطيب مجمع تجاري متكامل', 'benaa', 'construction', 'Al-Benaa Construction', 'شركة البناء', 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=800&q=80', 'Advanced electromechanical works, safety systems, and bespoke interior finishes for commercial retail spaces.', 'أعمال البنية التحتية والتشطيبات الكهروميكانيكية وأنظمة السلامة المتكاملة بمستوى عالمي.', 'Jeddah, Saudi Arabia', 'جدة، المملكة العربية السعودية', '2025', true),
  (5, 'Global Supply Chain & Freight Solutions', 'خدمات لوجستية وتوريد وشحن دولي', 'majd', 'logistics', 'Al-Majd Trading', 'شركة المجد', 'https://images.unsplash.com/photo-1578575437130-527eed3abbec?auto=format&fit=crop&w=800&q=80', 'End-to-end multimodal cargo shipping, bonded warehousing, and rapid customs clearance across GCC entry ports.', 'إدارة سلاسل الإمداد والشحن البحري والجوي والتخليص الجمركي السريع عبر كافة منافذ المملكة.', 'GCC & Saudi Ports', 'كافة المنافذ والموانئ', '2026', true)
ON CONFLICT (id) DO NOTHING;
